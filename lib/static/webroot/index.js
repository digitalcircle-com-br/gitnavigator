...
export function SetGlobalRefresh(a) {
    globalRefresh = a;
}
async function main() {
    //await api.init()
    ...
    let me = (localStorage.getItem("user") ? localStorage.getItem("user") : "N/A");
    let toolbar = {
        view: "toolbar",
        height: 50,
        background: "white",
        ...
        elements: [
            ...
            // },
            {
                template: "<img src='resources/logo.jpg' style='height: 40px;width: 40px'></img>",
                width: 58,
                borderless: true
            },
